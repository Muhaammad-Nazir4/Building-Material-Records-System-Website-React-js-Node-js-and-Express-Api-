...
export default function CompanyProfile() {
    ...
    useEffect(()=>{
        ...
        async function fetchData() {
          ...
          try {
            console.log(UserId);
            const response = await fetch(`http://localhost:4000/GetCompanyRating?UserId=${UserId}`);
            const data = await response.json();
    ...
    <div className="gradient-custom-2" >
      ...
      <Modal
          ...
          >
            ...
            <form enctype='multipart/form-data'  action={`http://localhost:4000/UpdateCompanyProfile?UserId=${UserId}`} method='post'>
