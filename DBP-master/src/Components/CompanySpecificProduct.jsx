...
function SpecificProduct() {
  ...
  useEffect(()=>{
    ...
    async function fetchData() {
      try {
        const response = await fetch(`http://localhost:4000/GetProductusingId?ProductId=${urlParams.get('ProductId')}`);
  ...
  return (
    ...
    <Modal
          ...
          <MDBCardBody>
            ...
            {console.log("ids",ids)}
            <form action={`http://localhost:4000/CompanyUpdateProduct?ProductId=${ids}`} encType='multipart/form-data' method="post">
            {<img
                  src={selectedImage}
                  alt="Selected"
                  style={{
      ...
      <Modal
          ...
          <MDBCardBody>
            ...
            {console.log("ids",ids)}
            {/* Product[0].Quantity */}
            <form action={`http://localhost:4000/CompanyAddStock?ProductId=${ids}&quantity=${quantity}`} method="post">
