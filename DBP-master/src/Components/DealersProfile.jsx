  ...
  const [dealerRating,setdealerRating] = useState(5);
    ...
    useEffect(()=>{
        ...
        async function fetchData() {
          try {
            console.log(UserId);
            const response = await fetch(`http://localhost:4000/GetDealerRatingUsingUserId?UserId=${urlParams.get('UserId')}`);
    ...
    <div className="gradient-custom-2" >
            ...
            <MDBCard>
              <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#007BFF', height: '200px' }}>
                <div className="ms-4 mt-5 d-flex flex-column" style={{ width: '150px' }}>
                  {Picture?(<MDBCardImage src={"http://localhost:4000/images/"+prof.Picture}alt="Generic placeholder image" className="mt-4 mb-2 img-thumbnail" fluid style={{ width: '150px', zIndex: '1' }} />)
      ...
      <Modal
          ...
          >
            ...
            <form enctype='multipart/form-data'  action={`http://localhost:4000/UpdateDealerProfile?UserId=${UserId}`} method='post'>
      ...
      <Modal
          ...
          >
            ...
            <button type="button" className="btn btn-danger btn-block mb-4" style={{maxWidth:"150px",marginTop:"10px",marginLeft:"auto",marginRight:"auto"}} onClick={()=>{window.location.href = `http://localhost:4000/DeleteUser?UserId=${localStorage.getItem('UserId')}`}}>Sure</button>
      </Modal>
