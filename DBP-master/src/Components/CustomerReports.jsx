...
const CustomerReports = () => {
    ...
    useEffect(()=>{
        async function fetchData() {
          try {
            const response = await fetch(`http://localhost:4000/CustomerPurchaseReport?UserId=${localStorage.getItem('UserId')}`);
      ...
      <div style={{ width: "10%" }}></div>
        <div style={{ width: "80%" }}>
          ...
          <div style={{ margin: "35px" }}>
            ...
            {/* <form action={`http://localhost:4000/uploadReports?pdf=${UserId}`} method="POST" enctype="multipart/form-data"> */}
