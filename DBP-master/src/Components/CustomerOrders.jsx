  ...
  export default function CustomerOrders() {
    ...
    useEffect(()=>{
        ...
        async function fetchData() {
          try {
            const response = await fetch(`http://localhost:4000/GetOrderofUserIdCustomer?UserId=${localStorage.getItem('UserId')}`);
      ...
      >
        ...
        <Modal
          ...
          >
            ...
            <form action={`http://localhost:4000/DealerReviewAndRating?rating=${rating}&ProductId=${ProductId}&UserId=${localStorage.getItem('UserId')}&DealerId=${localStorage.getItem('DealerId')}`} method="post" id="formreview">
