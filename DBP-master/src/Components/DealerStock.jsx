...
function DealerStock() {
  ...
  useEffect(()=>{
    ...
    async function fetchData() {
      try {
        const response = await fetch(`http://localhost:4000/GetDealerStock?UserId=${localStorage.getItem("UserId")}`);
