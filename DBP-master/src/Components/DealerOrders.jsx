  ...
  export default function DealerOrders() {
    ...
    useEffect(()=>{
        ...
        async function fetchData() {
          try {
            const response = await fetch(`http://localhost:4000/GetOrderofUserId?UserId=${localStorage.getItem('UserId')}`);
      ...
      >
        ...
        <Modal
          ...
          >
            ...
            <form action={`http://localhost:4000/CompanyReviewsAndRating?rating=${rating}&ProductId=${ProductId}&UserId=${localStorage.getItem('UserId')}`} method="post" id="formreview">
