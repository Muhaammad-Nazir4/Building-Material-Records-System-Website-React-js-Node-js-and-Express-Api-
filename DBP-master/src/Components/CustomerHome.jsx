...
const CustomerHome = () => {
  ...
  useEffect(()=>{
    ...
    async function fetchData() {
      ...
      try {
        const response = await fetch(`http://localhost:4000/GetProductsForCustomer?Category=${urlParams.get('Category')}`);
